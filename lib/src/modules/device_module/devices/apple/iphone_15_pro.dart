...
const iPhone15Pro = DeviceProperties(
  id: 'iphone-15-pro',
  name: 'iPhone 15 Pro',
  manufacturer: 'Apple',
  ...
  frameBuilder: _iPhone15ProFrame,
  // deviceFrame: _iPhone14Frame,
  // deviceKeyboard: _keyboard,
);

Widget _iPhone15ProFrame(BuildContext context, Widget child) {
  return DeviceWidget(
    frameBuilder: (context, screen) {
      return FrameButtonsWidget(
        ...
        child: StackedBordersWidget(
          ...
          borders: const [
            BorderSide(color: Color(0xFF010101), width: 30.0 / 3.0),
